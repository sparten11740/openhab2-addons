...
import static org.openhab.binding.edimax.EdimaxBindingConstants.THING_TYPE_SP1101W;
 ...
 */
@Component(service = ThingHandlerFactory.class, immediate = true, configurationPid = "binding.edimax", configurationPolicy = ConfigurationPolicy.OPTIONAL)
public class EdimaxHandlerFactory extends BaseThingHandlerFactory {

    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_SP1101W);
